package com.kuoji.prototypepattern.controller;

import com.kuoji.prototypepattern.AnswerQuestion;
import com.kuoji.prototypepattern.ChoiceQuestion;
import com.kuoji.prototypepattern.QuestionBank;
...
public class QuestionBankController {
    ...
    /**
     *  对外部提供创建试卷的方法，在创建的过程中使用的是克隆的方式
     *  (QuestionBank) questionBank.clone(); 并最终返回试卷信息
     */
